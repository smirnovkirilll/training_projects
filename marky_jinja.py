...
# description: this app uses advantages of markdown and jinja templating to make static site. it renders markdown file to temporary_html and after it renders temporary_html to ready_html with header, footer and css (theme) via jinja. ready html to be used as usual static site (i.e. githubpages)
